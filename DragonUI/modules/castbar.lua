...
function CastbarModule:HandleCastStart_Simple(unitType, unit, isChanneling)
    ...
    if isChanneling then
        -- WotLK 3.3.5a / this MoP server: name, rank, displayName, icon, startTime, endTime, isTradeSkill, notInterruptible
        spell, _, _, icon, startTime, endTime, _, notInterruptible = UnitChannelInfo(unit)
        castID = nil
    else
        -- WotLK 3.3.5a / this MoP server: name, rank, displayName, icon, startTime, endTime, isTradeSkill, castID, notInterruptible
...
function CastbarModule:HandleCastDelayed_Simple(unitType, unit)
    ...
    if castbar.castingEx then
        -- MoP 5.4.8: name, text, texture, startTime, endTime, isTradeSkill, castID, notInterruptible
