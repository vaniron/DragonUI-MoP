...
L["About"] = "정보"
L["Bringing the retail WoW look to 5.4.8, inspired by Dragonflight UI."] = "Dragonflight UI에서 영감을 받아 5.4.8에 리테일 WoW 느낌을 구현합니다."
L["Created and maintained by EncarnacionDev, with community contributions."] = "EncarnacionDev이 제작 및 유지하며, 커뮤니티가 기여합니다."
L["Language"] = "언어"
...
L["Outline"] = "외곽선"
L["Thickness of the black outline. WoW 5.4.8 has no real bold, so a thicker outline is what makes the number look heavier."] = "검은 외곽선의 두께입니다. WoW 5.4.8에는 실제 굵은 글꼴이 없으므로 외곽선을 두껍게 해야 숫자가 더 굵어 보입니다."
L["Thick"] = "두껍게"
...
L["Hide New Item Glow"] = "새 아이템 광택 숨기기"
L["Completely disables the white 'New Item' highlight on bag slots. Turn this on if you are playing on a server with the bug where all items glow every time you log in."] = "가방 칸의 흰색 '새 아이템' 표시를 완전히 비활성화합니다. 로그인할 때마다 모든 아이템에 광택이 표시되는 버그가 있는 서버에서 플레이하는 경우 이 옵션을 켜세요."
...
L["On 5.4.8, enemy cast bars appear on the targeted plate only."] = "5.4.8에서 적 시전 바는 대상 이름표에만 나타납니다."
