...
L["About"] = "关于"
L["Bringing the retail WoW look to 5.4.8, inspired by Dragonflight UI."] = "受巨龙时代UI启发，为5.4.8版本带来正式服《魔兽世界》的外观。"
L["Created and maintained by EncarnacionDev, with community contributions."] = "由EncarnacionDev创建和维护，并有社区贡献。"
L["Language"] = "语言"
...
L["Hide New Item Glow"] = "隐藏新物品高亮"
L["Completely disables the white 'New Item' highlight on bag slots. Turn this on if you are playing on a server with the bug where all items glow every time you log in."] = "完全禁用背包栏位上的白色“新物品”高亮。如果你在每次登录时所有物品都会发光的服务器上游玩，请开启此选项。"
...
L["On 5.4.8, enemy cast bars appear on the targeted plate only."] = "在 5.4.8 中，敌方施法条仅出现在目标姓名板上。"
...
L["Outline"] = "描边"
L["Thickness of the black outline. WoW 5.4.8 has no real bold, so a thicker outline is what makes the number look heavier."] = "黑色描边的粗细。WoW 5.4.8 没有真正的粗体，因此只有加粗描边才能让数字看起来更醒目。"
L["Thick"] = "粗"
