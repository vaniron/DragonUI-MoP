...
L["About"] = "Acerca de"
L["Bringing the retail WoW look to 5.4.8, inspired by Dragonflight UI."] = "Trayendo el aspecto del WoW retail a 5.4.8, inspirado en Dragonflight UI."
L["Created and maintained by EncarnacionDev, with community contributions."] = "Creado y mantenido por EncarnacionDev, con contribuciones de la comunidad."
L["Language"] = "Idioma"
...
L["Outline"] = "Contorno"
L["Thickness of the black outline. WoW 5.4.8 has no real bold, so a thicker outline is what makes the number look heavier."] = "Grosor del contorno negro. WoW 5.4.8 no tiene negrita real, así que un contorno más grueso es lo que hace que el número se vea más marcado."
L["Thick"] = "Grueso"
...
L["Pet action buttons per row."] = "Botones de acción de mascota por fila."
...
L["Max Height"] = "Altura máxima"
L["Maximum height of the quest tracker in pixels."] = "Altura máxima del rastreador de misiones en píxeles."
...
L["On 5.4.8, enemy cast bars appear on the targeted plate only."] = "En 5.4.8, las barras de lanzamiento enemigas solo aparecen en la placa del objetivo."
