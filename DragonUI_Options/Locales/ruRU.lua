...
L["About"] = "О программе"
L["Bringing the retail WoW look to 5.4.8, inspired by Dragonflight UI."] = "Вдохновлённый Dragonflight UI внешний вид актуального WoW, перенесённый в 5.4.8."
L["Created and maintained by EncarnacionDev, with community contributions."] = "Создано и поддерживается EncarnacionDev при участии сообщества."
L["Language"] = "Язык"
...
L["Outline"] = "Контур"
L["Thickness of the black outline. WoW 5.4.8 has no real bold, so a thicker outline is what makes the number look heavier."] = "Толщина чёрного контура. В WoW 5.4.8 нет настоящего полужирного начертания, поэтому число выглядит плотнее только за счёт более толстого контура."
L["Thick"] = "Толстый"
...
L["On 5.4.8, enemy cast bars appear on the targeted plate only."] = "В 5.4.8 вражеские полосы каста только на индикаторе цели."
