...
L["About"] = "關於"
L["Bringing the retail WoW look to 5.4.8, inspired by Dragonflight UI."] = "受巨龍時代UI啟發，為5.4.8版本帶來正式服《魔獸世界》的外觀。"
L["Created and maintained by EncarnacionDev, with community contributions."] = "由EncarnacionDev建立和維護，並有社群貢獻。"
L["Language"] = "語言"
...
L["On 5.4.8, enemy cast bars appear on the targeted plate only."] = "在 5.4.8 中，敵方施法條僅出現在目標名牌上。"
...
L["Outline"] = "外框"
L["Thickness of the black outline. WoW 5.4.8 has no real bold, so a thicker outline is what makes the number look heavier."] = "黑色外框的粗細。WoW 5.4.8 沒有真正的粗體，因此只有加粗外框才能讓數字看起來更醒目。"
L["Thick"] = "粗"
