...
L["About"] = true
L["Bringing the retail WoW look to 5.4.8, inspired by Dragonflight UI."] = true
L["Created and maintained by EncarnacionDev, with community contributions."] = true
...
L["Outline"] = true
L["Thickness of the black outline. WoW 5.4.8 has no real bold, so a thicker outline is what makes the number look heavier."] = true
L["Thick"] = true
...
L["On 5.4.8, enemy cast bars appear on the targeted plate only."] = true
