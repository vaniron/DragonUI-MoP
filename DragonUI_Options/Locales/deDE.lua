...
L["About"] = "Über"
L["Bringing the retail WoW look to 5.4.8, inspired by Dragonflight UI."] = "Der Retail-WoW-Look für 5.4.8, inspiriert von Dragonflight UI."
L["Created and maintained by EncarnacionDev, with community contributions."] = "Erstellt und gepflegt von EncarnacionDev, mit Beiträgen der Community."
L["Language"] = "Sprache"
...
L["Outline"] = "Umrandung"
L["Thickness of the black outline. WoW 5.4.8 has no real bold, so a thicker outline is what makes the number look heavier."] = "Stärke der schwarzen Umrandung. WoW 5.4.8 kennt kein echtes Fett, daher lässt erst eine dickere Umrandung die Zahl kräftiger wirken."
L["Thick"] = "Dick"
...
L["On 5.4.8, enemy cast bars appear on the targeted plate only."] = "In 5.4.8 erscheinen gegnerische Zauberbalken nur auf der anvisierten Plakette."
