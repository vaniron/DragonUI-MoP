...
local T = {
    bg        = { 0.06, 0.06, 0.07, 0.97 },
    border    = { 0.18, 0.18, 0.21, 1 },
    titleBg   = { 0.08, 0.09, 0.10, 1 },
    tabNormal = { 0.11, 0.11, 0.13, 1 },
    tabHover  = { 0.14, 0.14, 0.16, 1 },
    tabActive = { 0.18, 0.83, 0.75, 1 },
    accent    = { 0.18, 0.83, 0.75, 1 },
    textWhite = { 1, 1, 1, 1 },
    textDim   = { 0.61, 0.62, 0.65, 1 },
    contentBg = { 0.08, 0.09, 0.10, 1 },
...
local function CreatePanel()
    ...
    titleText:SetText("|cff2dd4bf" .. LO["DragonUI"] .. "|r |cffaaaaaa2.5|r")
    ...
    editorBtn:SetBackdropColor(0.11, 0.11, 0.13, 1)
    editorBtn:SetBackdropBorderColor(0.23, 0.23, 0.26, 1)
    local editorText = editorBtn:CreateFontString(nil, "OVERLAY")
    SetSafeFont(editorText, 11, "")
    editorText:SetPoint("CENTER", 0, 0)
    editorText:SetText("|cffc9ccd6" .. LO["Editor Mode"] .. "|r")
    ...
    editorBtn:SetScript("OnEnter", function()
        editorBtn:SetBackdropColor(0.14, 0.14, 0.16, 1)
        editorBtn:SetBackdropBorderColor(0.30, 0.30, 0.34, 1)
        editorText:SetText("|cffffffff" .. LO["Editor Mode"] .. "|r")
    end)
    ...
    keybindBtn:SetBackdropColor(0.11, 0.11, 0.13, 1)
    keybindBtn:SetBackdropBorderColor(0.23, 0.23, 0.26, 1)
    local keybindText = keybindBtn:CreateFontString(nil, "OVERLAY")
    SetSafeFont(keybindText, 11, "")
    keybindText:SetPoint("CENTER", 0, 0)
    keybindText:SetText("|cffc9ccd6" .. LO["KeyBind Mode"] .. "|r")
    ...
    keybindBtn:SetScript("OnEnter", function()
        keybindBtn:SetBackdropColor(0.14, 0.14, 0.16, 1)
        keybindBtn:SetBackdropBorderColor(0.30, 0.30, 0.34, 1)
        keybindText:SetText("|cffffffff" .. LO["KeyBind Mode"] .. "|r")
    end)
